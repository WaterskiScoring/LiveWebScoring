<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="T_Test.aspx.vb" Inherits="LiveWebScorebook22vb.T_Test" %>
...
<body>
   ...
   <!-- Store user selections -->
       ...
       <div class="container">
        ...
        <div class="row">
        <div class="col-xxl">
            <div id="Div1" runat="server" class="box">

           </div>
        </div>
        <div class="col-xxl">
            <div id="Div2" runat="server" class="box">

           </div>
        </div>
        <div class="col-xxl ">
            <div id="Div3" runat="server" class="box">
