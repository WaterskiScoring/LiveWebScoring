<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TROxRnd.aspx.vb" Inherits="LiveWebScoreBoard.TROxRnd" %>
    ...
    <asp:Panel ID="Panel_OnWater" runat="server" Visible="True">
        <div class="row">
           ...
           <asp:Panel ID="Panel_R1C1" runat="server" Visible="True">
            <div class="row">
                <div id="ColumnOne" runat="server" class="col-xxl box "></div>
                
            </div>
</asp:Panel>
     <asp:Panel ID="Panel_R1C2" runat="server" Visible="True">
            <div class="row">
                <div id="ColumnTwo" runat="server" class="box "></div>
           </div>
         </asp:Panel>
     <asp:Panel ID="Panel_R1C3" runat="server" Visible="True">
            <div class="row">
                <div id="ColumnThree" runat="server" class="col-xxl box ">
                </div>
           </div>
    </asp:Panel>
<asp:Panel ID="Panel_R1C4" runat="server" Visible="True">
             <div class="row">
                <div id="ColumnFour" runat="server" class="col-xxl box ">
                </div>
            </div>
         </asp:Panel>
