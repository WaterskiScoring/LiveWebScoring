Public Class TLeaderBoardSP
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Try
                ...
                If Not Regex.IsMatch(sFormatCode, "^[NCWROLBSP]*$") Then
                    sEM = "Invalid Request.  You may try again."
                    Session.Abandon()
                    Response.Redirect("~/default.aspx?EM=" & sEM)
                End If
                If sFormatCode <> "LBSP" Then  'Make sure this is the correct display form for the format
                    sEM = "Invalid Request.  You may try again."
                    Session.Abandon()
                    Response.Redirect("~/default.aspx?EM=" & sEM)
                End If
            ...
            If sFromTournament = "0" Then 'returning from TRecap
                ...
                UpdateLeaderboard()
            Else   'First pass from Tournament.aspx
  ...
  '              Panel_R1C1.Visible = True
  '              ColumnTwo.InnerHtml = ModDataAccess3.LeaderBoardBestRndLeftSP(sSanctionID, sYrPkd, sTournName, "T", sDivisionCodePkd, sRndsPkd, sSlalomrounds, sTrickRounds, sJumpRounds, sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
  '              Panel_R1C2.Visible = True
  '              ColumnThree.InnerHtml = ModDataAccess3.LeaderBoardBestRndLeftSP(sSanctionID, sYrPkd, sTournName, "J", sDivisionCodePkd, sRndsPkd, sSlalomrounds, sTrickRounds, sJumpRounds, sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
  '              Panel_R1C3.Visible = True
  '              ColumnFour.InnerHtml = ModDataAccess3.LeaderBoardBestRndLeftSP(sSanctionID, sYrPkd, sTournName, "O", sDivisionCodePkd, sRndsPkd, sSlalomrounds, sTrickRounds, sJumpRounds, sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
  '              Panel_R1C4.Visible = True
            ...
            Case "T"
                ...
                If UCase(sPlcmntFormat) = "ROUND" Then
                    ColumnOne.InnerHtml = ModDataAccess3.LeaderBoardROUND(sSanctionID, sYrPkd, sTournName, "T", sDivisionCodePkd, sRndsPkd, sSlalomrounds, sTrickRounds, sJumpRounds, sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
                Else
                    ColumnOne.InnerHtml = ModDataAccess3.LeaderBoardBestRndLeftSP(sSanctionID, sYrPkd, sTournName, "T", sDivisionCodePkd, sRndsPkd, sSlalomrounds, sTrickRounds, sJumpRounds, sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
                End If
                Panel_R1C1.Visible = True
                    Panel_R1C2.Visible = False
                Panel_R1C3.Visible = False
            ...
            Case "J"
                ...
                If UCase(sPlcmntFormat) = "ROUND" Then
                    ColumnOne.InnerHtml = ModDataAccess3.LeaderBoardROUND(sSanctionID, sYrPkd, sTournName, "J", sDivisionCodePkd, sRndsPkd, sSlalomrounds, sTrickRounds, sJumpRounds, sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
                Else
                    ColumnOne.InnerHtml = ModDataAccess3.LeaderBoardBestRndLeftSP(sSanctionID, sYrPkd, sTournName, "J", sDivisionCodePkd, sRndsPkd, sSlalomrounds, sTrickRounds, sJumpRounds, sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
                End If
                Panel_R1C1.Visible = True
                    Panel_R1C2.Visible = False
                Panel_R1C3.Visible = False
                Panel_R1C4.Visible = False
            Case "O" 'overall
                ColumnOne.InnerHtml = ModDataAccess3.LeaderBoardBestRndLeftSP(sSanctionID, sYrPkd, sTournName, "O", sDivisionCodePkd, sRndsPkd, sSlalomrounds, sTrickRounds, sJumpRounds, sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
                Panel_R1C2.Visible = False
                Panel_R1C3.Visible = False
                Panel_R1C4.Visible = False
        End Select
