<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TXDVcRunOrd.aspx.vb" Inherits="LiveWebScoreBoard.TXDVcRunOrd" %>
...
<head runat="server">
 <!-- Required meta tags -->
    ...
    <title>Scores By RunOrder</title>
            ...
            <div class="text-bg-info text-center">
                <b>Events: </b> <asp:DropDownList ID="DDL_EventsPkd" runat="server" AutoPostBack="true"></asp:DropDownList>
                       <b>Divisions: </b><asp:DropDownList ID="DDL_DvPkd" runat="server" AutoPostBack="true"></asp:DropDownList>
                        <asp:DropDownList ID="DDL_PkRnd" runat="server" visible="false" Enabled="false"></asp:DropDownList>
...
<div class="row">
    <asp:Panel ID="Panel_R1C1" runat="server" Visible="True">
            ...
            <div class="col-xl box" id="ColumnOne" runat="server"></div>


</asp:Panel>
     <asp:Panel ID="Panel_R1C2" runat="server" Visible="True">

            <div class="col-xl box" id="ColumnTwo" runat="server" ></div>


         </asp:Panel>
     <asp:Panel ID="Panel_R1C3" runat="server" Visible="True">

            <div class="col-xl box" id="ColumnThree" runat="server" ></div>
