        ...
        If Not IsPostBack Then
            ...
            Try
                ...
                If Not Regex.IsMatch(sFormatCode, "^[NCWROLB]*$") Then
                    ...
                    Response.Redirect("~/default.aspx?EM=" & sEM)
                End If
                If sFormatCode <> "LB" Then  'Make sure this is the correct display form for the format
                    sEM = "Invalid Request.  You may try again."
                    Session.Abandon()
                    Response.Redirect("~/default.aspx?EM=" & sEM)
                End If
    ...
    Private Sub UpdateLeaderboard()
        ...
        Select Case sEventCodePkd
            Case "0"
                ...
                Panel_R1C4.Visible = False
            Case "A"
                ColumnOne.InnerHtml = ModDataAccess3.LeaderBoardBestRndLeft(sSanctionID, sYrPkd, sTournName, "S", sDivisionCodePkd, sRndsPkd, sSlalomrounds, sTrickRounds, sJumpRounds, sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
                Panel_R1C1.Visible = True
                ColumnTwo.InnerHtml = ModDataAccess3.LeaderBoardBestRndLeft(sSanctionID, sYrPkd, sTournName, "T", sDivisionCodePkd, sRndsPkd, sSlalomrounds, sTrickRounds, sJumpRounds, sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
                Panel_R1C2.Visible = True
                ColumnThree.InnerHtml = ModDataAccess3.LeaderBoardBestRndLeft(sSanctionID, sYrPkd, sTournName, "J", sDivisionCodePkd, sRndsPkd, sSlalomrounds, sTrickRounds, sJumpRounds, sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
            ...
            Case "T"
                ColumnOne.InnerHtml = ModDataAccess3.LeaderBoardBestRndLeft(sSanctionID, sYrPkd, sTournName, "T", sDivisionCodePkd, sRndsPkd, sSlalomrounds, sTrickRounds, sJumpRounds, sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
                Panel_R1C1.Visible = True
                Panel_R1C2.Visible = False
                Panel_R1C3.Visible = False
                Panel_R1C4.Visible = False
            Case "J"
                ColumnOne.InnerHtml = ModDataAccess3.LeaderBoardBestRndLeft(sSanctionID, sYrPkd, sTournName, "J", sDivisionCodePkd, sRndsPkd, sSlalomrounds, sTrickRounds, sJumpRounds, sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
                Panel_R1C1.Visible = True
                Panel_R1C2.Visible = False
                Panel_R1C3.Visible = False
                Panel_R1C4.Visible = False
            Case "O" 'overall
                ColumnOne.InnerHtml = ModDataAccess3.LeaderBoardBestRndLeft(sSanctionID, sYrPkd, sTournName, "O", sDivisionCodePkd, sRndsPkd, sSlalomrounds, sTrickRounds, sJumpRounds, sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
                Panel_R1C2.Visible = False
                Panel_R1C3.Visible = False
                Panel_R1C4.Visible = False
        End Select
